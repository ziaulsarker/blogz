...
Typescript provides a type system to existin javascript. Our variable can now have a types and interfaces associated with them. Typescript also provides a great tooling system, for our IDEs, some of with are autocomplete, type annotations, etc.
