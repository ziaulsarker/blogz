...
for example self driving cars are an example of reinforced leaning the car is learning which yeld the most positive outcomes (staying in lane, maintaining speed, not crashing)
