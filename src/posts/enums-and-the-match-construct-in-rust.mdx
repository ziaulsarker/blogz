---
title: Enums and the match construct in rust 
slug: enums-and-the-match-construct-in-rust
img: /enums-and-the-match-construct-in-rust.jpeg
...
The CatchAllArm case name is arbitrary we can name it what ever we want, but in rust its convention to use the _ and the name of the catch all arms case.
