...
In essence that is the logic behind decorater, however we dont write them like shoed above. we write decorators with the @expression in python and typescript
