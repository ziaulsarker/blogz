...
<strong> useFormStatus </strong> is part of reacts effort for server component. useFormStatus is a react hook hence the prefix use the captures details on the most recent form submitted.
